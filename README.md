...
6. **Lab validation** — typo-tolerant strain match against **GrowthDB** (5,163 literature-cited records), the reported medium bound from the **Media DB**, then FBA — predicted μ<sub>max</sub> vs measured growth rate with an honest verdict and a secretion-pattern check.
